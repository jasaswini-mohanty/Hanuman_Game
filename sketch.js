...
function setup(){
 ...
 if(gamestate==home) {
  ...
  if(gamestate == instructions ) {
    ...
    fill("white");
    textSize(18);
    text("-Press play to start game.",width/5,100);
...
function spawncyclops() {
  if(World.frameCount%150==0) {
    var cyclops=createSprite(800,random(200,300),0,0);
...
function spawnseamonster(){
  ...
  // monster2.addAnimation("seamonster",seamonsteranime);
   
  //seamonsteranime=createImg("seamonster.gif",50,300);
  //seamonsteranime.position(random(100,300),monster2.y);
